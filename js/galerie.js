...
let imgSource = "../images/chef.png";

let monImage = getImage(titre,imgSource);

monImage += getImage('Titre', '../images/christmas-wallpaper.jpg');
monImage += getImage('Titre', '../images/saumon.png');
monImage += getImage('Titre', '../images/lasagna-5994612_1280.jpg');
monImage += getImage('Titre', '../images/wine.jpg');
monImage += getImage('Titre', '../images/food-5282718_1280.jpg');
